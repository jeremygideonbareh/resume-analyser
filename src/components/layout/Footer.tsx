      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-10 sm:px-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <p className="max-w-md text-xs leading-relaxed text-muted">
            <LetterCascade
              text="Privacy first: no uploads, no cookies — parsing runs entirely in your browser. Analyses run while signed in are saved to your account so you can review them in your dashboard. Your resume text is never stored. Sign out or delete your history any time."
        ...
        <div className="border-t border-ink/10 pt-5 font-mono text-[11px] uppercase tracking-[0.14em] text-muted">
          <div className="flex flex-wrap gap-x-8 gap-y-2">
            ...
            <span>v0.1.0</span>
            <span>Privacy first — no uploads, no cookies, no resume-text storage</span>
          </div>
        </div>
      </div>
    </footer>
